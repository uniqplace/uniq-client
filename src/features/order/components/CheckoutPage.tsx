...
export const CheckoutPage: React.FC<CheckoutPageProps> = (props) => {
  ...
  const validate = () => {
    ...
    else if (address.state.length < 2) errors.state = 'State must be at least 2 characters';
    if (!address.zipCode) errors.zipCode = 'Zip code is required';
    else if (!/^\d{4,10}$/.test(address.zipCode)) errors.zipCode = 'Invalid zip code';
        ...
        <div className="checkout-summary">
          ...
          <div style={{ background: '#f6f7fb', borderRadius: 8, padding: 24, boxShadow: '0 1px 6px #0001' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
              <span><i className="pi pi-box mr-2" />Product Total</span>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 700, fontSize: 20 }}>
              <span><i className="pi pi-credit-card mr-2" />Total Due</span>
